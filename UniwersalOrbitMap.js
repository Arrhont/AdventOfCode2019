...
class Planet {
    ...
    addSatellite(planet) {
        if (this.hasSatellite(planet)) return this;
...
class Galaxy {
    constructor(input) {
        ...
        function planetsCreate(names) {
            const planets = new Map();

            for (const name of names) {
                planets.set(name, new Planet(name));
            }
    ...
    getPathBetweenPlanets(planetA, planetB) {
        if (planetA === planetB) {
